# 왜 KerML은 `Property`가 아니라 `Feature`라는 단어를 선택했을까?
...
이 정도 되면 Feature를 단순히 ‘속성’이라고 번역하는 순간 의미가 반쯤 증발합니다. 명세가 갑자기 사람 잡는 괴문서가 되는 이유가 번역 하나 때문일 수도 있습니다. 언어 설계자는 멀쩡했는데 번역이 칼을 들고 설치는 셈입니다.
